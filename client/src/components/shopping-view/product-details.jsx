...
function ProductDetailsDialog({open,setOpen,productDetails})
{
  ...
  if (indexOfCurrentItem > -1) {
    ...
    if (getQuantity>=productDetails?.totalStock) {
      toast({
        title: `Only ${productDetails?.totalStock} quantity can be added for this item`,
        variant: "destructive",
      });
      return;
    }
  ...
  dispatch(
    ...
    return(
        <Dialog open={open} onOpenChange={handleDialogClose}>
            <DialogContent className="grid grid-cols-2 gap-8 sm:p-12 max-w-[90vw] sm:max-w-[80vw] lg:max-w-[70vw] bg-white text-black rounded-lg">
